...
# doAnalysis(process,process.newdigiseq,"p6s384NoNeut",384,6,0.0,cms.vint32(1,1,1,1,1,1), True,True,False)
doAnalysis(process,process.newdigiseq,"p8s384",384,8,2.0,cms.vint32(1,1,1,1,1,1), True,True,False)
doAnalysis(process,process.newdigiseq,"p8s384Def",384,8,2.0,cms.vint32(1,1,1,1,1,1), True,True,True)
# doAnalysis(process,process.newdigiseq,"p6s384DefNoNeut",384,6,0.0,cms.vint32(1,1,1,1,1,1), True,True,True)
