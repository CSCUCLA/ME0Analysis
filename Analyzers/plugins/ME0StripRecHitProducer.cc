...
//*/
//
//#include "ME0StripRecHitProducer.h"
//#include "FWCore/Framework/interface/MakerMacros.h"
//
//ME0StripRecHitProducer::ME0StripRecHitProducer(const edm::ParameterSet& config){
//
...
//  theAlgo = new ME0StripRecHitAlgo(config.getParameter<edm::ParameterSet>("recAlgoConfig"));
//}
//
//
//ME0StripRecHitProducer::~ME0StripRecHitProducer(){
//  delete theAlgo;
//}
//
//
//
//void ME0StripRecHitProducer::beginRun(const edm::Run& r, const edm::EventSetup& setup){
//}
//
//
//
//void ME0StripRecHitProducer::produce(edm::Event& event, const edm::EventSetup& setup) {
//
...
//
//
//DEFINE_FWK_MODULE(ME0StripRecHitProducer);
//
